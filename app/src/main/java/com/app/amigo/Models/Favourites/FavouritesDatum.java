...
public class FavouritesDatum{
    ...
    @SerializedName("loc")
    @Expose
    private FavouritesLoc loc;
    @SerializedName("status")
    @Expose
    private String status;
    @SerializedName("gallery")
    @Expose
    private List<FavouritesGallery> gallery = null;
    ...
    public FavouritesLoc getLoc() {
        return loc;
    }

    public void setLoc(FavouritesLoc loc) {
        this.loc = loc;
    }
    ...
    public List<FavouritesGallery> getGallery() {
        return gallery;
    }

    public void setGallery(List<FavouritesGallery> gallery) {
