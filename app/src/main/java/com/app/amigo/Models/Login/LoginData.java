...
package com.app.amigo.Models.Login;
...
public class LoginData {
    ...
    @SerializedName("loc")
    @Expose
    private LoginLoc loc;
    @SerializedName("status")
    @Expose
    private String status;
    @SerializedName("gallery")
    @Expose
    private List<LoginGallery> gallery = null;
    ...
    public LoginLoc getLoc() {
        return loc;
    }

    public void setLoc(LoginLoc loc) {
        this.loc = loc;
    }
    ...
    public List<LoginGallery> getGallery() {
        return gallery;
    }

    public void setGallery(List<LoginGallery> gallery) {
