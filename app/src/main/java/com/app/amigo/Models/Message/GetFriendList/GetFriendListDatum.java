...
public class GetFriendListDatum {
    ...
    @SerializedName("loc")
    @Expose
    private GetFriendListLoc loc;
    @SerializedName("status")
    @Expose
    private String status;
    @SerializedName("gallery")
    @Expose
    private List<GetFriendListGallery> gallery = null;
    ...
    public GetFriendListLoc getLoc() {
        return loc;
    }

    public void setLoc(GetFriendListLoc loc) {
        this.loc = loc;
    }
    ...
    public List<GetFriendListGallery> getGallery() {
        return gallery;
    }

    public void setGallery(List<GetFriendListGallery> gallery) {
