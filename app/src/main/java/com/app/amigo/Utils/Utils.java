...
import com.app.amigo.Adapters.DialogPagerAdapter;
...
public class Utils {
    ...
    public static void loginActivitychangeFragment(Context context, androidx.fragment.app.Fragment fragment) {

        androidx.fragment.app.FragmentManager fragmentManager = ((FragmentActivity) context).getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.mainContainer, fragment).addToBackStack(null).commitAllowingStateLoss();
    ...
    public static void changeFragment(Context context, androidx.fragment.app.Fragment fragment) {
        ...
        androidx.fragment.app.FragmentManager fragmentManager = ((FragmentActivity) context).getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.selGender_container, fragment).addToBackStack(null).commitAllowingStateLoss();

    }

    public static void changeFragment2(Context context, androidx.fragment.app.Fragment fragment) {

        androidx.fragment.app.FragmentManager fragmentManager = ((FragmentActivity) context).getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.home_Container, fragment).addToBackStack(null).commitAllowingStateLoss();
